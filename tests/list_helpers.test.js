...
describe('total likes', () => {
  ...
  test('sum of likes for a blog list', () => {
    const result = listHelper.totalLikes(listBlogs)
    expect(result).toBe(36)
  })

  test('sum of likes for an empty blog list', () => {
...
describe('favorite blog', () => {
  ...
  test("favorite blog for an empty blog list", () => {
    const result = listHelper.favoriteBlog(emptyblogs)
    expect(result).toEqual({})
  })
})

describe('most blogs (author and blogs number)', () => {
  test("when list has only one blog, equals the blog", () => {
  ...
  test("most blogs for an empty blog list", () => {
